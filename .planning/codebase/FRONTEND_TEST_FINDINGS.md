...
| 7 | i18n | `frontend/src/pages/meetings/MeetingsPage.tsx:178`, `frontend/src/pages/posts/PostListPage.tsx:363,371-380` | Page heading hardcoded English while every other string on the page is correctly localized. Confirmed on two pages: Meetings (`"Your <span>meetings</span>"`) and the posts directory (`"05 My Posts"/"05 Directory"`, `"Your posts"` / `"Collaboration opportunities"` — found while auditing finding #6). |
