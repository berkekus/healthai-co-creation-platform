      ...
      <PageWrapper maxWidth={520} padTop="clamp(32px, 6vw, 64px)">
        <div className="flex flex-col items-center text-center py-10">
          <div className="w-20 h-20 rounded-3xl bg-hai-mint flex items-center justify-center mb-6 shadow-[0_20px_40px_-20px_rgba(54,33,62,0.3)]">
            <span className="material-symbols-outlined text-hai-plum text-[44px]" style={{ fontVariationSettings: '"FILL" 1' }}>lock_reset</span>
          </div>
          <h1 className="font-headline font-bold text-[36px] text-hai-plum mb-3 leading-tight">Password reset!</h1>
          <p className="text-[14.5px] text-neutral-600 mb-6 max-w-sm leading-relaxed">
