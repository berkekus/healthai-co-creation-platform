      ...
      <form onSubmit={handleSubmit} className="mb-6">
        {replyTo && (
          <div className="mb-2 flex items-center gap-2 rounded-lg bg-[#F5F5F7] px-3 py-1.5 text-xs font-semibold text-[#6F6878]">
            ...
            <button type="button" onClick={() => setReplyTo(null)} aria-label={t('comments.cancelReply')} className="ml-auto text-[#9CA3AF] hover:text-hai-plum">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    <span className="text-xs text-[#9CA3AF]">{timeAgo(comment.createdAt, t)}</span>
                  </div>
                    ...
                    <li key={reply.id} className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex flex-wrap items-center gap-2">
                          ...
                          <span className="text-[10px] text-[#9CA3AF]">{timeAgo(reply.createdAt, t)}</span>
                        </div>
